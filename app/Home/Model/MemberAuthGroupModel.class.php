 ...
 */
class MemberAuthGroupModel extends Model {
    const TYPE_ADMIN                = 1;                   // 管理员用户组类型标识
    const MEMBER                    = 'member';
    const UCENTER_MEMBER            = 'ucenter_member';
    const AUTH_GROUP_ACCESS         = 'member_auth_group_access'; // 关系表表名
    const AUTH_EXTEND               = 'member_auth_extend';       // 动态权限扩展信息表
    const AUTH_GROUP                = 'member_auth_group';        // 用户组表名
